...
winrt::fire_and_forget QuickBluePlugin::DiscoverServicesAsync(std::shared_ptr<BluetoothDeviceAgent> bluetoothDeviceAgent) {
...
winrt::fire_and_forget QuickBluePlugin::RequestMtuAsync(std::shared_ptr<BluetoothDeviceAgent> bluetoothDeviceAgent, uint64_t expectedMtu) {
...
winrt::fire_and_forget QuickBluePlugin::SetNotifiableAsync(std::shared_ptr<BluetoothDeviceAgent> bluetoothDeviceAgent, std::string service, std::string characteristic, std::string bleInputProperty) {
...
winrt::fire_and_forget QuickBluePlugin::ReadValueAsync(std::shared_ptr<BluetoothDeviceAgent> bluetoothDeviceAgent, std::string service, std::string characteristic) {
  auto gattCharacteristic = co_await bluetoothDeviceAgent->GetCharacteristicAsync(service, characteristic);
  if(gattCharacteristic != nullptr) {
...
winrt::fire_and_forget QuickBluePlugin::WriteValueAsync(std::shared_ptr<BluetoothDeviceAgent> bluetoothDeviceAgent, std::string service, std::string characteristic, std::vector<uint8_t> value, std::string bleOutputProperty) {
  auto gattCharacteristic = co_await bluetoothDeviceAgent->GetCharacteristicAsync(service, characteristic);
  if(gattCharacteristic != nullptr) {
